...
This gallery provides detailed descriptions and visual examples of the complete AS-StageFX collection, which includes **88 shaders** across four categories: **29 Background (BGX)**, **23 Graphic (GFX)**, **3 Lighting (LFX)**, and **33 Visual (VFX)** effects.
