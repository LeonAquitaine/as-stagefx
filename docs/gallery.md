...
<strong>License:</strong> CC Share-Alike Non-Commercial <span style="color:#888;font-size:90%">(CC BY-NC-SA)</span>
</td>
...
<strong>License:</strong> Creative Commons Attribution 4.0 International <span style="color:#888;font-size:90%">(CC BY 4.0)</span>
</td>
<td width="50%"><div style="text-align:center">
