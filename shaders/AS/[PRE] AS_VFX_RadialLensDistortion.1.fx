...
// ============================================================================
technique AS_VFX_RadialLensDistortion < ui_tooltip = "Simulates various lens distortions like tangential (rotational) blur, chromatic aberration, and geometric warping (barrel/pincushion).\nIncludes presets for specific lens characteristics. Effect is strongest at edges."; >
{
    pass
    {
