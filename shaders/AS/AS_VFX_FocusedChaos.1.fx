...
uniform float TimeColorShiftFactor  < ui_type = "slider"; ui_label = "Color Evolution"; ui_tooltip = "Controls how much time influences color changes in the nebula patterns."; ui_min = TIME_COLOR_SHIFT_MIN; ui_max = TIME_COLOR_SHIFT_MAX; ui_step = 0.01f; ui_category = AS_CAT_COLOR; > = TIME_COLOR_SHIFT_DEFAULT;
uniform float NoiseColorScale1      < ui_type = "slider"; ui_label = "Texture Color Scale A"; ui_tooltip = "First scaling factor for processing texture colors from noise."; ui_min = NOISE_COLOR_SCALE1_MIN; ui_max = NOISE_COLOR_SCALE1_MAX; ui_step = 0.01f; ui_category = AS_CAT_COLOR; > = NOISE_COLOR_SCALE1_DEFAULT;
uniform float NoiseColorBias1       < ui_type = "slider"; ui_label = "Texture Color Bias A"; ui_tooltip = "Bias applied after first scaling of texture colors."; ui_min = NOISE_COLOR_BIAS1_MIN; ui_max = NOISE_COLOR_BIAS1_MAX; ui_step = 0.01f; ui_category = AS_CAT_COLOR; > = NOISE_COLOR_BIAS1_DEFAULT;
uniform float NoiseColorScale2      < ui_type = "slider"; ui_label = "Texture Color Scale B"; ui_tooltip = "Second scaling factor for processing texture colors."; ui_min = NOISE_COLOR_SCALE2_MIN; ui_max = NOISE_COLOR_SCALE2_MAX; ui_step = 0.001f; ui_category = AS_CAT_COLOR; > = NOISE_COLOR_SCALE2_DEFAULT;
uniform float FractureColorOffset   < ui_type = "slider"; ui_label = "Shadow Tint Seed"; ui_tooltip = "Offsets the color input for shadow calculations, can tint darker areas."; ui_min = FRACTURE_COLOR_OFFSET_MIN; ui_max = FRACTURE_COLOR_OFFSET_MAX; ui_step = 0.01f; ui_category = AS_CAT_COLOR; > = FRACTURE_COLOR_OFFSET_DEFAULT;
uniform float FacBias               < ui_type = "slider"; ui_label = "Shadow Bias"; ui_tooltip = "Adjusts the threshold or bias for darker, outer areas of the effect."; ui_min = FAC_BIAS_MIN; ui_max = FAC_BIAS_MAX; ui_step = 0.01f; ui_category = AS_CAT_COLOR; > = FAC_BIAS_DEFAULT;
uniform float FacScale              < ui_type = "slider"; ui_label = "Shadow Intensity"; ui_tooltip = "Scales the intensity of the darker, outer areas of the effect."; ui_min = FAC_SCALE_MIN; ui_max = FAC_SCALE_MAX; ui_step = 0.01f; ui_category = AS_CAT_COLOR; > = FAC_SCALE_DEFAULT;
...
uniform float FinalMixFactorBias    < ui_type = "slider"; ui_label = "Core/Edge Balance"; ui_tooltip = "Bias for the mix between the emissive core and outer effect areas."; ui_min = FINAL_MIX_BIAS_MIN; ui_max = FINAL_MIX_BIAS_MAX; ui_step = 0.01f; ui_category = AS_CAT_FINAL; > = FINAL_MIX_BIAS_DEFAULT;
uniform float EffectAlphaExponent   < ui_type = "slider"; ui_label = "Transparency Falloff"; ui_tooltip = "Controls the sharpness of the transparency falloff from core to edge."; ui_min = EFFECT_ALPHA_EXPONENT_MIN; ui_max = EFFECT_ALPHA_EXPONENT_MAX; ui_step = 0.01f; ui_category = AS_CAT_FINAL; > = EFFECT_ALPHA_EXPONENT_DEFAULT;
uniform bool  EnableDithering       < ui_label = "Enable Dithering"; ui_tooltip = "Adds a small amount of noise to reduce color banding."; ui_category = AS_CAT_FINAL; > = true;
uniform float DitherStrength        < ui_type = "slider"; ui_label = "Dither Strength"; ui_tooltip = "Strength of the dithering effect."; ui_min = DITHER_STRENGTH_MIN; ui_max = DITHER_STRENGTH_MAX; ui_step = 0.01f; ui_category = AS_CAT_FINAL; > = DITHER_STRENGTH_DEFAULT;
